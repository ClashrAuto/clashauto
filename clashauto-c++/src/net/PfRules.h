...
//
//        流数            1 流        4 流         8 流
//        Windows 直连   88.9 MB/s   202.5 MB/s   170.7 MB/s   ← 局域网本身是 2.5G 级
//        Mac 做端点     27.2 MB/s    53.5 MB/s      —         ← 这台 Mac 的空口上限 ~0.45 Gbps
//        经 Mac pf 网关  8.4 MB/s    12.3 MB/s     14.2 MB/s
//
//      Wi-Fi 是**半双工共享介质**，做网关时每个字节要过两次空口（设备→Mac、Mac→服务器），
//      所以它的理论转发上限约是端点上限的一半 ≈ 26 MB/s —— 实测 14.2 是其 55%。
...
//        转发上限的约 2×，而不是 18×。
//      ★ 剩下那 ~2× 尚未定位（Wi-Fi 竞争/重传、多一跳回环拷贝都可能），但**在 Mac 接到
